...
private:
  ...
  size_t tokenize_buffer(const unsigned char *inbuf, const size_t min_bufsize,
                         unsigned char *outbuf) const;
  ...
  static constexpr unsigned char iso8859_norm_table[256] = {
      ...
      'y',  'z',  0x7b, 0x7c, 0x7d, 0x7e, 0x7f, 0x80, 0x81, 0x82, 0x83, 0x84,
      ...
      0xb5, 0xb6, 0xb7, 0xb8, 0xb9, 0xba, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf, 'a',
      'a',  'a',  'a',  'a',  'a',  'a',  'c',  'e',  'e',  'e',  'e',  'i',
      'i',  'i',  'i',  'd',  'n',  'o',  'o',  'o',  'o',  'o',  0xd7, 'o',
      'u',  'u',  'u',  'u',  'y',  0xde, 's',  'a',  'a',  'a',  'a',  'a',
      'a',  'a',  'c',  'e',  'e',  'e',  'e',  'i',  'i',  'i',  'i',  'o',
      'n',  'o',  'o',  'o',  'o',  'o',  0xf7, 'o',  'u',  'u',  'u',  'u',
      'y',  0xfe, 'y'};
